...
CREATE DATABASE IF NOT EXISTS `Corteva` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
# DATE(MM-DD-YYYY)	AUTHOR\EMAIL ADDRESS		 DESCRIPTION    
##########################################################################
CREATE TABLE IF NOT EXISTS CCC_FACT_WEATHER_ROLLUP(
	  WEATHER_ROLLUP_KEY INT NOT NULL AUTO_INCREMENT
	, YEAR_KEY INT NOT NULL
    , WEATHER_STATION_KEY INT NOT NULL
    , AVG_MAX_TEMP DECIMAL(6,2) NULL
    , AVG_MIN_TEMP DECIMAL(6,2) NULL
    , TOT_PRECIPITATION DECIMAL(6,2) NULL
